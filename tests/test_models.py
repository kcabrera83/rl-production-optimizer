...
def test_models():
    results = {}
    results['action_policy'] = evaluate_model(os.path.join(MODEL_DIR, 'action_policy_model.pkl'), X, y)
    results['reward'] = evaluate_model(os.path.join(MODEL_DIR, 'reward_predictor.pkl'), X, y)
    return results
